...
# SSL termination happens at the ingress proxy — Django must not redirect.
# Set DJANGO_SECURE_SSL_REDIRECT=true only if Django itself handles TLS.
